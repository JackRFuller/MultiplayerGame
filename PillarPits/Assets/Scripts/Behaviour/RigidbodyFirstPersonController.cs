...
public class RigidbodyFirstPersonController : MonoBehaviour
{
    ...
    {	
        ...
        if ((CrossPlatformInputManager.GetButton("Jump") || Input.GetButton("A")) && !m_Jump)
        {
            m_Jump = true;
        }

		if((CrossPlatformInputManager.GetButtonDown("Fire3") || Input.GetButtonDown("LB")) && !JetPacking)
		{
			if(TotalFuel > 0)
			{
				JetPacking = true;
